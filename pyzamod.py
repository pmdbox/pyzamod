...
TestStation.addDb('192.168.100.17','5432','database','login','password')
TestStation.addDevice(DIRISA40NEW,'KVP10',1)
TestStation.addDevice(DIRISA40NEW,'KVP11',2)

TestStation2 = StationRTU()
TestStation2.SetConnParams('COM6','rtu',38400)
TestStation2.addZabbixReceiver('192.168.100.17')
TestStation2.addDb('192.168.100.17','5432','database','login','password')
